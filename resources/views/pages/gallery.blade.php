    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="gallery-filter d-none d-sm-block">
                ...
                <button class="btn btn-default filter-button" data-filter="sprinkle">charity</button>
                <button class="btn btn-default filter-button" data-filter="spray"> ngo</button>
                <button class="btn btn-default filter-button" data-filter="irrigation">Children</button>
            </div>
            <br/>


            <div class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter hdpe">
                <img src="{{('public/assets/images/events/image_01.jpg')}}" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter sprinkle">
                <img src="{{('public/assets/images/events/image_02.jpg')}}" class="img-responsive">
            </div>
            ...
            <div class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter irrigation">
                <img src="{{('public/assets/images/events/image_03.jpg')}}" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter spray">
                <img src="{{('public/assets/images/events/image_04.jpg')}}" class="img-responsive">
            </div>



            <div class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter spray">
                <img src="{{('public/assets/images/events/image_05.jpg')}}" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-3 col-md-3 col-sm-4 col-xs-6 filter irrigation">
                <img src="{{('public/assets/images/events/image_06.jpg')}}" class="img-responsive">
            </div>

            <div class="gallery_product col-lg-3 col-md-4 col-sm-3 col-xs-6 filter irrigation">
                <img src="{{('public/assets/images/events/image_07.jpg')}}" class="img-responsive">
            </div>
...
<div class="copy">
    <div class="container">
        <a href="https://www.smarteyeapps.com/">2021 &copy; All Rights Reserved | Designed and Developed by 8 detech</a>
